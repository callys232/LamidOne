...
/**
 * Public F02 — same calculator as /dashboard/budget, reachable with no
 * account. The line items and settings can be filled in by anyone;
 * only the computed result requires signing in, same pattern as
 * /diagnostics/[code].
 */
      ...
      <main id="main">
        <div className="shell max-w-3xl py-16 space-y-8">
          ...
          <div className="card p-6">
            ...
            {needsAuth && (
              <div className="mt-5 card p-6 text-center" style={{ borderColor: "var(--brand)" }}>
                <p className="font-display text-lg">Create a free account to see the total.</p>
                <p className="muted mt-2 text-sm">Your line items stay as you left them — this calculator is free on every plan.</p>
